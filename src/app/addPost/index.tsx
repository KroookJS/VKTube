...
export default function AddPost() {
  ...
  const { categoryFile, modelFile, userCook } = useGlobalContext()
    ...
    <div className={styles.WrapperForm}>
      ...
      <div className={styles.ImgContainer}>
        <img
          ...
          alt="privImg"
        />
        <h3 className={styles.TitleBlock}>{title ? title : "title"}</h3>
      </div>
      ...
      <div className={styles.BtnBlock}>
        <button className="btnPorn" onClick={() => setIsEdit(true)}>
          Вернуться назад
        </button>
