...
import { HeaderProfile } from "@/components/Profile/HeadProfile/HeaderProfile";
...
export default function CatigoryPage({ userData }: { userData: IUser }) {
  ...
  return (
    <>
      <Layout
        title={`${
          userData.fullName ? userData.fullName : "TelePorn"
        } Porn Videos - Verified Porn Star Profile &#124; TelePorn`}
        description={`Porn ${
